...
export const getGetSharingAgreementByIdResponseMock = (overrideResponse: Partial< SharingAgreementResponse > = {}): SharingAgreementResponse => ({id: faker.string.uuid(), plantId: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 20}}), notes: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), status: faker.helpers.arrayElement(['DRAFT','PUBLISHED','SUPERSEDED'] as const), installedPowerKw: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), createdAt: `${faker.date.past().toISOString().split('.')[0]}Z`, createdBy: faker.string.uuid(), updatedAt: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`,null,]), updatedBy: faker.helpers.arrayElement([faker.string.uuid(),null,]), file: {id: faker.string.uuid(), filename: faker.string.alpha({length: {min: 10, max: 20}}), uploadedAt: `${faker.date.past().toISOString().split('.')[0]}Z`}, ...overrideResponse})

export const getUpdateSharingAgreementResponseMock = (overrideResponse: Partial< SharingAgreementResponse > = {}): SharingAgreementResponse => ({id: faker.string.uuid(), plantId: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 20}}), notes: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), status: faker.helpers.arrayElement(['DRAFT','PUBLISHED','SUPERSEDED'] as const), installedPowerKw: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), createdAt: `${faker.date.past().toISOString().split('.')[0]}Z`, createdBy: faker.string.uuid(), updatedAt: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`,null,]), updatedBy: faker.helpers.arrayElement([faker.string.uuid(),null,]), file: {id: faker.string.uuid(), filename: faker.string.alpha({length: {min: 10, max: 20}}), uploadedAt: `${faker.date.past().toISOString().split('.')[0]}Z`}, ...overrideResponse})
...
export const getGetSharingAgreementsResponseMock = (): SharingAgreementResponse[] => (Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), plantId: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 20}}), notes: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), status: faker.helpers.arrayElement(['DRAFT','PUBLISHED','SUPERSEDED'] as const), installedPowerKw: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), createdAt: `${faker.date.past().toISOString().split('.')[0]}Z`, createdBy: faker.string.uuid(), updatedAt: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`,null,]), updatedBy: faker.helpers.arrayElement([faker.string.uuid(),null,]), file: {id: faker.string.uuid(), filename: faker.string.alpha({length: {min: 10, max: 20}}), uploadedAt: `${faker.date.past().toISOString().split('.')[0]}Z`}})))

export const getCreateSharingAgreementResponseMock = (overrideResponse: Partial< SharingAgreementResponse > = {}): SharingAgreementResponse => ({id: faker.string.uuid(), plantId: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 20}}), notes: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), status: faker.helpers.arrayElement(['DRAFT','PUBLISHED','SUPERSEDED'] as const), installedPowerKw: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), createdAt: `${faker.date.past().toISOString().split('.')[0]}Z`, createdBy: faker.string.uuid(), updatedAt: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`,null,]), updatedBy: faker.helpers.arrayElement([faker.string.uuid(),null,]), file: {id: faker.string.uuid(), filename: faker.string.alpha({length: {min: 10, max: 20}}), uploadedAt: `${faker.date.past().toISOString().split('.')[0]}Z`}, ...overrideResponse})

export const getRevertSharingAgreementToDraftResponseMock = (overrideResponse: Partial< SharingAgreementResponse > = {}): SharingAgreementResponse => ({id: faker.string.uuid(), plantId: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 20}}), notes: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), status: faker.helpers.arrayElement(['DRAFT','PUBLISHED','SUPERSEDED'] as const), installedPowerKw: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), createdAt: `${faker.date.past().toISOString().split('.')[0]}Z`, createdBy: faker.string.uuid(), updatedAt: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`,null,]), updatedBy: faker.helpers.arrayElement([faker.string.uuid(),null,]), file: {id: faker.string.uuid(), filename: faker.string.alpha({length: {min: 10, max: 20}}), uploadedAt: `${faker.date.past().toISOString().split('.')[0]}Z`}, ...overrideResponse})

export const getPublishSharingAgreementResponseMock = (overrideResponse: Partial< SharingAgreementResponse > = {}): SharingAgreementResponse => ({id: faker.string.uuid(), plantId: faker.string.uuid(), name: faker.string.alpha({length: {min: 10, max: 20}}), notes: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), status: faker.helpers.arrayElement(['DRAFT','PUBLISHED','SUPERSEDED'] as const), installedPowerKw: faker.number.float({min: undefined, max: undefined, fractionDigits: 2}), createdAt: `${faker.date.past().toISOString().split('.')[0]}Z`, createdBy: faker.string.uuid(), updatedAt: faker.helpers.arrayElement([`${faker.date.past().toISOString().split('.')[0]}Z`,null,]), updatedBy: faker.helpers.arrayElement([faker.string.uuid(),null,]), file: {id: faker.string.uuid(), filename: faker.string.alpha({length: {min: 10, max: 20}}), uploadedAt: `${faker.date.past().toISOString().split('.')[0]}Z`}, ...overrideResponse})
