...
export type PlantResponseInverterProvider = typeof PlantResponseInverterProvider[keyof typeof PlantResponseInverterProvider];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PlantResponseInverterProvider = {
  HUAWEI: 'HUAWEI',
} as const;
