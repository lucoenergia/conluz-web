...
export type UpdatePlantBodyInverterProvider = typeof UpdatePlantBodyInverterProvider[keyof typeof UpdatePlantBodyInverterProvider];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdatePlantBodyInverterProvider = {
  HUAWEI: 'HUAWEI',
} as const;
