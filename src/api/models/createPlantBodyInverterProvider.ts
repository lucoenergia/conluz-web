...
export type CreatePlantBodyInverterProvider = typeof CreatePlantBodyInverterProvider[keyof typeof CreatePlantBodyInverterProvider];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreatePlantBodyInverterProvider = {
  HUAWEI: 'HUAWEI',
} as const;
