 ...
 */
export type SharingAgreementReferenceResponseStatus = typeof SharingAgreementReferenceResponseStatus[keyof typeof SharingAgreementReferenceResponseStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SharingAgreementReferenceResponseStatus = {
  DRAFT: 'DRAFT',
  PUBLISHED: 'PUBLISHED',
