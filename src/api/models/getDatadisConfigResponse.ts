 ...
 */
import type { GetDatadisConfigResponseUsername } from './getDatadisConfigResponseUsername';

export interface GetDatadisConfigResponse {
  username: GetDatadisConfigResponseUsername;
  passwordSet: boolean;
  baseUrl: string;
  enabled: boolean;
}
