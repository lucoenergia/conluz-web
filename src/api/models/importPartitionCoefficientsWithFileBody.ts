...
export type ImportPartitionCoefficientsWithFileBody = {
  /** TXT file from the distribution company. Format: CUPS;coefficient (comma decimal separator). File name must follow the pattern: CAU_YYYY.txt. */
  file: Blob;
};
