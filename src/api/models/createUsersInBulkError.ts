 ...
 */
import type { CreateUsersInBulkErrorPersonalId } from './createUsersInBulkErrorPersonalId';

export interface CreateUsersInBulkError {
  personalId: CreateUsersInBulkErrorPersonalId;
  errorMessage: string;
}
