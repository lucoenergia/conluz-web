...
export const Login: FC = () => {
  ...
  return (
    <Box component="form" className="p-7 w-full" action={handleSubmit}>
      ...
      {loginError && <Typography color="error">DNI/NIF o contraseña incorrectos</Typography>}
      <FormGroup>
        ...
        <Box className="flex flex-row justify-between items-center w-full">
          <FormControlLabel control={<Checkbox name="remember" />} label="Recordarme" className="mt-2" />
        ...
        <Link component={RouterLink} to="/contact" underline="always" color="info">
